...
<head>
    ...
    <title>Bienvenue sur mon site eshop</title>
...
<body class="d-flex flex-column h-100">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav me-auto mb-2 mb-md-0">
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="http://localhost/minotaure/S14-PHP/01-Syntaxe/projetInclude/index.php">Accueil</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="http://localhost/minotaure/S14-PHP/01-Syntaxe/projetInclude/inscription.php">Inscription</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="http://localhost/minotaure/S14-PHP/01-Syntaxe/projetInclude/connexion.php">Connexion</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="?cat=gaming">Gaming</a></li>
                                <li><a class="dropdown-item" href="?cat=audio">Audio</a></li>
                            </ul>
                        </li>
                    </ul>
    ...
    <footer class="footer mt-auto py-3 bg-body-tertiary fixed-bottom">
        <div class="container">
            <span class="text-body-secondary">Copyrith &copy; Pierra 2025</span>
        </div>
    </footer>
