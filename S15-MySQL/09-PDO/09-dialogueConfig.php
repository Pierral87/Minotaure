...
// 02 - Créer une connexion à cette base avec PDO
// Ici on va piocher les informations de notre fichier config.json
...
//   'db_name' => string 'dialogue' (length=8)

// Je défini les informations de connexion à ma BDD via les informations récupérées dans le JSON, ce qui me permet de centraliser les informations plus sensibles, dans ce json plutôt que dans mon code
$dbName = $config["db_name"];
$hostName = $config["db_host"];
$login = $config["db_user"];
$password = $config["db_password"];

$host = "mysql:host=$hostName;dbname=$dbName"; 
$options = array(
