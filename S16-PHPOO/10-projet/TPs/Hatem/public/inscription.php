...
<form method="POST" action="../traitement/function_inscription.php" class="bg-white p-6 rounded shadow-md w-full max-w-md">
    <label class="block mb-2">
        Nom :
        <input type="text" name="nom" class="w-full border rounded p-2 mt-1" required>
    </label>
    ...
    <!-- <label class="block mb-4">
        Rôle :
        <select name="role" class="w-full border rounded p-2 mt-1">
